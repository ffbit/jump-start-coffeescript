...
Level = (function() {
  ...
  Level.prototype.update = function() {
    var block, ninja, p, row, x, y, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2;
    _ref = this.map;
    ...
    for (_l = 0, _len3 = _ref2.length; _l < _len3; _l++) {
      ninja = _ref2[_l];
      this.checkCollision(this.game.player, ninja);
    }
  ...
  Level.prototype.render = function(gfx) {
    var block, ninja, p, row, x, y, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _results;
    _ref = this.map;
    for (y = _i = 0, _len = _ref.length; _i < _len; y = ++_i) {
      row = _ref[y];
      for (x = _j = 0, _len1 = row.length; _j < _len1; x = ++_j) {
